						...
						<div className="space-y-6">
							...
							<div className="bg-gray-50 rounded-xl p-4">
								...
								<div className="space-y-2">
									<button className="w-full flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors cursor-pointer">
										<svg
